module github.com/riotkit-org/waf-proxy/container-files/opt/build/caddy

go 1.17

require github.com/corazawaf/coraza-caddy v1.2.0
...
require (
	...
	github.com/corazawaf/coraza/v2 v2.0.0-rc.3 // indirect
